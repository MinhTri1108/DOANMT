...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $counttbsgv= ThongBaoGV::where(['MaGV'=> session()->get('id_gv')])->sum('status');
            $view->with('data', $giangvien)->with('notificationgv', $notificationgv)->with('counttbsgv', $counttbsgv);
        });
        ...
        ->join('quyen', 'quyen.idloaitk', '=', 'dsadmin.idloaitk')->where(['MaSV'=> session()->get('id_sv')])
