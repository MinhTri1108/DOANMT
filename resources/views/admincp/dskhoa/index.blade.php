                    ...
                    <table id="example" class="table table-striped table-bordered data-table" width="100%" data-page-length="25" data-order="[[ 1, &quot;asc&quot; ]]">
                        ...
                        @foreach($listkhoas as $listkhoa)
                            <tr id="row{{ $listkhoa->MaKhoa }}" >
                                ...
                                <td>
                                    <a href="{{route('')}}">{{$listkhoa->TenKhoa}}</a>
                                </td>
                                <td>
                                    {{$listkhoa->DiaChiKhoa}}
                                </td>
                                ...
                                @csrf
                                    <a href="#" id="{{$listkhoa->MaKhoa }}" class="text-success mx-1 editIcon" data-bs-toggle="modal" data-bs-target="#editEmployeeModal"><i class="bi-pencil-square h4"></i></a>
                                </td>
                                <td>
                                    @method('DELETE')
                                     <a href="#" id="{{$listkhoa->MaKhoa }}" class="text-danger mx-1 deleteIcon"><i class="bi-trash h4"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
