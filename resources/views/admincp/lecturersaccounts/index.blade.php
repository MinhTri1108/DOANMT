                    ...
                    <table id="example" class="table table-striped table-bordered data-table" width="100%" data-page-length="25" data-order="[[ 1, &quot;asc&quot; ]]">
                        ...
                        @foreach($listlecturersaccounts as $listlecturersaccount)
                            <tr id="row{{ $listlecturersaccount->MaGV }}" >
                                <td>
                                    <img src="{{ asset('./images/'.$listlecturersaccount->avatar) }}" width="50" class="img-thumbnail rounded-circle">
                                ...
                                <td>
                                    @method('DELETE')
                                     <a href="#" id="{{$listlecturersaccount->MaSV }}" class="text-danger mx-1 deleteIcon"><i class="bi-trash h4"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
...
$(function() {
    ...
    Swal.fire({
        ...
        if(result.isConfirmed)
        {
            ...
            url: "{{ URL('/admin/LecturersAccounts')}}"+'/'+id,
    ...
    $.ajax({
        url: "{{route('LecturersAccounts.store')}}",
        type: "method",
        method: 'post',
        data: formdata,
        cache: false,
