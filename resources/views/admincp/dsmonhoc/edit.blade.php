            ...
            <div class="card shadow">
                ...
                <div class="card-body" id="">
                    @if(session('status'))
                     ...
                     @endif
                    <form class="row g-3" method="POST" action="{{route('DanhSachMonHoc.update',[$monhoc->MaMonHoc])}}">
                        @method("PUT")
                        @csrf
                        <div class="col-md-6">
                            <label for="slug" class="form-label">Tên Môn Học</label>
                            <input type="text" name="TenMonHoc" class="form-control"  placeholder="Tên Môn học" value = "{{$monhoc->TenMonHoc}}">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input list="lts" name="LT" id="lt" value = "{{$monhoc->LT}}">
                            <datalist id="lts">
                                <option value="0">
                                <option value="20">
                                <option value="25">
                        ...
                        <div class="col-md-6">
                            ...
                            <input list="ths" name="TH" id="th" value = "{{$monhoc->TH}}">
                            <datalist id="ths">
                                <option value="0">
                                <option value="20">
                                <option value="25">
                        ...
                        <div class="col-md-6">
                            ...
                            <input list="tls" name="TL" id="tl" value = "{{$monhoc->TL}}">
                            <datalist id="tls">
                                <option value="0">
                                <option value="20">
                                <option value="25">
                        ...
                        <div class="col-md-6">
                            ...
                            <input list="tts" name="TT" id="tt" value = "{{$monhoc->TT}}">
                            <datalist id="tts">
                                <option value="0">
                                <option value="20">
                                <option value="25">
