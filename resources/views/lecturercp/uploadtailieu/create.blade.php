        ...
        <div class="col">
            <div class="card shadow">
                ...
                <h3 class="text-light">Upload file tài liệu</h3>
                 <button class="btn btn-light"><a href="{{route('UploadFileTaiLieu.index')}}">Danh sách file đã up</a></button>
                 @if ($errors->any())
                ...
                <div class="card-body" id="">
                    @if(session('status'))
                     ...
                     @endif
                    <form class="row g-3" method="POST" action="{{route('UploadFileTaiLieu.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" type="textarea" name="MoTa" id="MoTa" maxlength="6000" rows="7" required></textarea>
                            </textarea>
                        </div>
                        <div class="col-12">
